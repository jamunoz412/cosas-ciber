...
\newcommand{\logoMachine}{images/mantis_logo.png} % Logo de la máquibna
...
\begin{document}
    ...
    \begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{images/mantis.jpeg}
    ...
    \begin{figure}[h]
    \begin{center}
    \includegraphics[width=0.8\textwidth]{images/newt_discover.png}
    \end{center}
    ...
    \begin{figure}[h]
    \begin{center}
    \includegraphics[width=\textwidth]{images/initial_recon.png}
    \end{center}
    \caption{Reconocimiento inicial sobre el sistema objetivo}    
    \end{figure}
    ...
    \begin{figure}[h]
    \centering
    \makebox[\textwidth]{\includegraphics[width=0.9\paperwidth]{images/initial_recon.png}}
